...
/*
 * FIXME:
 * 3250 has a different clock register layout than other exynos4 platforms.
 * However, most of the client code is the same as for exynos4.
 * Figure out how to refactor this properly.
*/
/*
